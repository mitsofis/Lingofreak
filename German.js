<script>
    ...
    function checkExercise9() {
        const answers = {
            'ex9-1-bav': ['Servus! Wo geht’s dir?', 'Servus! Wo geht’s?', 'Servus! Wo geht’s dir, gell?'],
            'ex9-1-swa': ['Grüß di! Wie goht’s dir?', 'Grüß di! Wie goht’s?', 'Grüß di! Wie goht’s dir, ma?'],
            ...
            'ex9-3-bav': ['Geh, mia schwätzen a bisserl!', 'Geh, mia schwätzen!', 'Geh, mia schwätzen, gell!'],
            'ex9-3-swa': ['Geh, mir schwätzen en babbel!', 'Geh, mir schwätzen!', 'Geh, mir schwätzen, ma!'],
    ...
    function checkExercise10() {
        const answers = {
            'ex10-1': ['Beide Texte beschreiben einen sonnigen Tag, wo Leute sich treffen und entspannen.', 'Beide Texte handeln von einem sonnigen Tag mit Leuten, die sich treffen.', 'Die Texte beschreiben beide sonnige Tage mit sozialen Aktivitäten.'],
            'ex10-2': ['Text 1 ist höflich und formell, Text 2 ist locker und freundschaftlich.', 'Text 1 ist formell, Text 2 ist informell.', 'Text 1 klingt höflich, Text 2 ist entspannt.'],
            'ex10-3': ['Die Hunde jagen etwas und bellen.', 'Die Hunde laufen hinter etwas her und bellen.', 'In beiden Texten jagen Hunde etwas und bellen.']
        };
        let correct = 0;
        let feedback = '<h5>Feedback:</h5><ul>';
        Object.keys(answers).forEach((id, index) => {
