...
/**
 * Utility functions for general use across exercises.
 */
...
// === START: TAB SWITCHING ===
/**
 * Handles tab navigation by showing/hiding tab content and updating active states.
 */
...
/**
 * Handles text-to-speech with feedback messages.
 */
function speak(text, lang) {
    const utterance = new SpeechSynthesisUtterance(text);
    utterance.lang = lang;

    // Feedback on audio start
    utterance.onstart = () => {
        document.getElementById("audio-feedback").innerHTML = 
            '<div class="alert alert-info">Playing audio...</div>';
    };

    // Feedback on audio end
    utterance.onend = () => {
        document.getElementById("audio-feedback").innerHTML = 
            '<div class="alert alert-success">Audio finished.</div>';
        setTimeout(() => {
            document.getElementById("audio-feedback").innerHTML = "";
        }, 2000);
    };

    // Feedback on audio error
    utterance.onerror = () => {
        document.getElementById("audio-feedback").innerHTML = 
            '<div class="alert alert-danger">Error playing audio.</div>';
    };
...
// === START: DRAG AND DROP SETUP ===
/**
 * Sets up drag-and-drop functionality for Exercises 2 and 3.
 */

// Drag and Drop for Exercise 2 (Matching Phrases)
function setupDragAndDropExercise2() {
...
function setupDragAndDropExercise3() {
...
// Randomize words in each sentence-drag-list for Exercise 3
...
// === START: EXERCISE CHECK FUNCTIONS ===
/**
 * Functions to check user answers for each exercise.
 */
...
// === END: EXERCISE CHECK FUNCTIONS ===

// === START: INITIALIZATION ===
/**
 * Initializes the application by setting up drag-and-drop and randomizing words.
 */
function initialize() {
    // Assign unique IDs to draggable words
    ...
    setupDragAndDropExercise2();
    setupDragAndDropExercise3();

    // Randomize words for Exercise 3
    randomizeWords();
}
